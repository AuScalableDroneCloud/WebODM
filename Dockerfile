...
# Install Node.js
RUN apt-get -qq update && apt-get -qq install -y --no-install-recommends wget curl apt-utils && \
    ...
    npm install --quiet -g webpack@4.46.0 && npm install --quiet -g webpack-cli@4.10.0 && npm install --quiet && webpack --mode production && \
